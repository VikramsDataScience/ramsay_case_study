...
### DRG analysis
<b>N.B. For this section please refer to the `src.drg_analysis` module and plots generated by this module title `max_Charges_by_DRG.html` and `sum_Charges_by_DRG.html`.</b><br>
For DRGs, I've looked and plotted with Plotly the DRGs that generate the Maximum revenue, the Mean, and the total Sum over the full course of the dataset:
...
<b>N.B. For this section please refer to the `src.sql_queries` module. And, for the results of those queries, please refer to `data/Total_Average_Admissions.csv` and `data/Total_Charges_by_Diagnosis.csv`</b><br>